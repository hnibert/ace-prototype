...
I have a keen interest in coding, open science, analyses, and learning new quantitative methods, I am most proud of my capacity to lead diverse interdisciplinary teams through integrative processes, combining varied expertise, lived experiences, and quantitative methods to co-develop next-generation marine resource management and decision support tools. I have found that collaborations across diverse interdisciplinary teams is both crucial for efficient, effective, and publicly accessible science as well as fundamental to my own personal and professional growth.

**Public Repositories Include**
- [2023 Multispecies Stock Assessment for the Bering Sea, AK](https://github.com/kholsman/2023_Multispp_assessment){: target="_blank" rel="noopener"}
- [2020 CEATTLE ACLIM2 simulations (Holsman et al. 2020)](https://github.com/kholsman/ACLIM-CEATTLE){: target="_blank" rel="noopener"}
- [ACLIM2 simulations and data wrangling](https://github.com/kholsman/ACLIM2){: target="_blank" rel="noopener"}
- [2023 Tipping Points workshop](https://github.com/kholsman/Tipping-Points){: target="_blank" rel="noopener"}
- [ICES workshop for climate aware advice (WKCLIMAD)](https://github.com/kholsman/WKCLIMAD){: target="_blank" rel="noopener"}