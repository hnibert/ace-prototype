...
This site is built on a serverless [Jamstack](https://jamstack.org/) architecture designed for high performance, security, and a streamlined editorial workflow.
