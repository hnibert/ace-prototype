...
management_bodies: [International Pacific Halibut Commission, NOAA Fisheries, North Pacific Fishery Management Council]
...
protections: Northern Pacific Halibut Act of 1982
protection_notes: null

#Justification for Classification (use a '>-' block scalar indicator for text below)
justification: |
    Halibut were selected as a "Species of Concern" due to their importance in multiple fishey sectors including being targeted by the commercial longline fishery, by recreational fishers, and by Traditional subsistence users (for personal use). 
    <https://iphc.int/management/fisheries>. 
