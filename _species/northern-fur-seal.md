...
#General
species_name: Northern Fur Seal 
scientific_name: Callorhinus ursinus
other_names: Laaqudan

species_type: sea-and-river-animals

#Management
management_structure: Co-management
management_bodies: [NOAA Fisheries, Tribal Governments of St. George and St. Paul]
...
ccv_notes: |
    ...
    “Nutritional limitation was also linked to depletion of prey resources due to climate-related or general ecosystem changes/impacts, including reduced prey abundances and/or shifting prey distribution.” (Divine et al., 2022); One participant of Divine et al. (2022) said, “Ocean temperatures and environments are changing and affecting the seals’ food source. They’re not finding enough food to survive”. Pollock is a key component of northern fur seal diets on the Pribilof Islands [64,70,74,75]. 
...
protection_notes: |
    Listed as depleted under Marine Mammal Protection Act (NOAA, 50 CFR Part 216 [Docket No. 50219-8058; Protected under Fur Seal Act;  “regulatory closures [for Pribilof Islands] that prohibit unauthorized human access beyond posted fur seal breeding and resting sites from 1 June to 15 October each year, establishment of Aircraft Advisory Zones and Requested Aircraft Flight Paths, and new subsistence use regulations” (Muto et el, 2022); Northern fur seals are protected under the North Pacific Fur Seal Commission Treaty

#Justification for Classification (use a '>-' block scalar indicator for text below)
justification: |
    Northern Fur Seals were selected as a species of concern due to their use as a vital cultural and subsistence resource for Unangan (the Aleut people) of St. Paul Island, Alaska for food, cultural continuity, arts, and crafts (Divine et al., 2021).
    
    The Pribilof Islands in Alaska were once home to about 75% of the world’s northern fur seals, but populations have shown a dramatic unexplained decline in recent decades. And lastly, a total of 286 laaqudan were harvested during the 2020 harvest season (Divine et al;., 2021).
justification_notes: 

#Cultural Significance (use a '>-' block scalar indicator for text below)
cultural_significance: | 
    Considered a cultural keystone species for Pribilof Islands Unangan (Torrey, 1978).
